        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-gray-700">
            ...
            <p className="mt-4  leading-relaxed text-gray-600">
              ...
              analysis, and strategic guidance needed to navigate fast-changing
              markets and stay ahead of the competition. Whether you&apos;re
              launching new products, entering new categories, or refining your
              go-to-market approach, we help you spot opportunities early and
              pivot when needed. Our insights are built to guide long-term
              growth while supporting agile decision-making in real time.
            </p>
            ...
            <ul className="mt-8 space-y-5">
              {[
                ...
                <li key={item.title} className="flex items-start">
                  ...
                  <p className="ml-4">
                    <strong className="font-semibold  text-[#063668]">
                      {item.title}
                    </strong>{' '}
                    — {item.desc}
                  </p>
