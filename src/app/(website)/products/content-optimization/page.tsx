...
import productsPage3 from '../../../../../public/product/xyz.png'
...
const Page = () => {
  return (
    <div>
      ...
      <div className="mt-20">
        <ServicePaidSearch
          id={slugify('content-optimization')}
      ...
      <ServicePaidSearch
        id={slugify('smart-classification')}
      ...
      <VisibilityIntelligence id={slugify('insights-engine')} />
