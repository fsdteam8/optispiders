...
const Page = () => {
  return (
    <div>
      ...
      <ServicePaidSearch
        id={slugify('product-page-content')}
      ...
      <RatailMediaNetwork
        id={slugify('retailer-brand-stores')}
      ...
      <ReuseableTwo
        id={slugify('advertising-creative')}
      ...
      />
      <SyndicationSupport id={slugify('content-syndication-support')} />
