      ...
      <div className="container mx-auto py-32 ">
        <div className="flex flex-col md:flex-row justify-center md:justify-between items-center">
          <div className="md:w-1/2">
            <h2 className="text-[#063668] text-[32px] md:text-[48px] font-bold mb-6">{title}</h2>
            <p className="text-xs md:text-[16px] font-normal text-[#2F2F2F] mb-12 leading-[120%]">{description}</p>
            <a
              href={buttonLink}
